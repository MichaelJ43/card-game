...
import { SUITS, canPlay, cmd, handId, topDiscard, totalPlayers } from './helpers'
import type { Crazy8sGameState } from './types'

export const crazy8sLogic: Pick<
  GameModule<Crazy8sGameState>,
  | 'setup'
  | 'getLegalActions'
  | 'applyAction'
  | 'statusText'
  | 'extractMatchRoundScores'
  | 'isMatchRoundFinished'
> = {
  setup(ctx, instances) {
